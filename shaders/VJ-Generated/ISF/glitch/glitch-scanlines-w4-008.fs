/*{
    "DESCRIPTION": "Glitch scanlines glitch-scanlines-8-1781761128112",
    ...
    "INPUTS": [
        ...
        { "NAME": "lineDensity", "TYPE": "float", "DEFAULT": 105.0, "MIN": 20.0, "MAX": 120.0 },
        { "NAME": "jitterAmp", "TYPE": "float", "DEFAULT": 0.076, "MIN": 0.0, "MAX": 0.15 }
    ]
}*/
