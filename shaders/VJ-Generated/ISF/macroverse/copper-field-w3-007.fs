/*{
    "DESCRIPTION": "Copper field copper-field-7-1781759867658",
    ...
    "INPUTS": [
        ...
        { "NAME": "driftSpeed", "TYPE": "float", "DEFAULT": 0.273, "MIN": 0.0, "MAX": 0.5 },
        { "NAME": "fieldScale", "TYPE": "float", "DEFAULT": 4.04, "MIN": 0.5, "MAX": 5.0 }
    ]
}*/
