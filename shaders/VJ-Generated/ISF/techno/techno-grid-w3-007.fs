/*{
    "DESCRIPTION": "Techno grid techno-grid-7-1781759867669",
    ...
    "INPUTS": [
        ...
        { "NAME": "cellCount", "TYPE": "float", "DEFAULT": 7.0, "MIN": 2.0, "MAX": 24.0 },
        { "NAME": "pulseRate", "TYPE": "float", "DEFAULT": 1.88, "MIN": 0.2, "MAX": 4.0 }
    ]
}*/
