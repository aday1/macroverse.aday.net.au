/*{
    "DESCRIPTION": "Techno grid techno-grid-0-1781758991415",
    ...
    "INPUTS": [
        ...
        { "NAME": "cellCount", "TYPE": "float", "DEFAULT": 14.0, "MIN": 2.0, "MAX": 24.0 },
        { "NAME": "pulseRate", "TYPE": "float", "DEFAULT": 2.50, "MIN": 0.2, "MAX": 4.0 }
    ]
}*/
