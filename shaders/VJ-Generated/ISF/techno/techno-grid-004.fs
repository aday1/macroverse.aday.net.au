/*{
    "DESCRIPTION": "Techno grid techno-grid-4-1781758904598",
    ...
    "INPUTS": [
        ...
        { "NAME": "cellCount", "TYPE": "float", "DEFAULT": 11.0, "MIN": 2.0, "MAX": 24.0 },
        { "NAME": "pulseRate", "TYPE": "float", "DEFAULT": 1.21, "MIN": 0.2, "MAX": 4.0 }
    ]
}*/
