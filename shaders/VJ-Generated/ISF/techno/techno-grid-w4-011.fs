/*{
    "DESCRIPTION": "Techno grid techno-grid-11-1781761127857",
    ...
    "INPUTS": [
        ...
        { "NAME": "cellCount", "TYPE": "float", "DEFAULT": 13.0, "MIN": 2.0, "MAX": 24.0 },
        { "NAME": "pulseRate", "TYPE": "float", "DEFAULT": 1.06, "MIN": 0.2, "MAX": 4.0 }
    ]
}*/
