/*{
    "DESCRIPTION": "Techno grid techno-grid-10-1781758904602",
    ...
    "INPUTS": [
        ...
        { "NAME": "cellCount", "TYPE": "float", "DEFAULT": 5.0, "MIN": 2.0, "MAX": 24.0 },
        { "NAME": "pulseRate", "TYPE": "float", "DEFAULT": 0.90, "MIN": 0.2, "MAX": 4.0 }
    ]
}*/
