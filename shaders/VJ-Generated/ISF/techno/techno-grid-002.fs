/*{
    "DESCRIPTION": "Techno grid techno-grid-2-1781758904597",
    ...
    "INPUTS": [
        ...
        { "NAME": "cellCount", "TYPE": "float", "DEFAULT": 12.0, "MIN": 2.0, "MAX": 24.0 },
        { "NAME": "pulseRate", "TYPE": "float", "DEFAULT": 0.78, "MIN": 0.2, "MAX": 4.0 }
    ]
}*/
