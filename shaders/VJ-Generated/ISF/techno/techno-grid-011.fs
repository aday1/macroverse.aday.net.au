/*{
    "DESCRIPTION": "Techno grid techno-grid-11-1781758904603",
    ...
    "INPUTS": [
        ...
        { "NAME": "cellCount", "TYPE": "float", "DEFAULT": 10.0, "MIN": 2.0, "MAX": 24.0 },
        { "NAME": "pulseRate", "TYPE": "float", "DEFAULT": 1.46, "MIN": 0.2, "MAX": 4.0 }
    ]
}*/
