/*{
    "DESCRIPTION": "Techno grid techno-grid-9-1781759867671",
    ...
    "INPUTS": [
        ...
        { "NAME": "cellCount", "TYPE": "float", "DEFAULT": 6.0, "MIN": 2.0, "MAX": 24.0 },
        { "NAME": "pulseRate", "TYPE": "float", "DEFAULT": 1.39, "MIN": 0.2, "MAX": 4.0 }
    ]
}*/
