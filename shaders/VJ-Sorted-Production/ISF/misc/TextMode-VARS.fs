...
void main( void ) {
	...
	{inRED}_ _ HEART HEART HEART HEART HEART HEART HEART HEART HEART HEART HEART
	slashN ;
	{inWHT}_ _ G DASH G DASH G O _ B A C K
	slashN ;
	{inWHT}_ _ T O _ R E D D I T c += txColor*Sprite3x5(336.,floor(p-cpos));cpos.x += 3.;if(cpos.x > 61.) slashN c += txColor*Sprite3x5(2176.,floor(p-cpos));cpos.x += 3.;if(cpos.x > 61.) slashN
	slashN ;
	{inWHT}_ _ S E N P A I EXCLAM EXCLAM n1 n1
	slashN;
	{inRED}_ _ HEART HEART HEART HEART HEART HEART HEART HEART HEART HEART HEART
