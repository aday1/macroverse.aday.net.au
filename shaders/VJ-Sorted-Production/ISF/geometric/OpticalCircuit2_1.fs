...
// Obfuscated code can eat a dick; I'd rather it be written in hebrew ffs.
//
// /agree - whoever wrote this can suck a dick. freaking sweet multi-layer effect tho.
// very hard to follow what is going on in the code though.
