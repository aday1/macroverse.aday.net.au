...
void _userMain(void)
{
	...
	d += A(r()); add(); d += N(r()); add(); d += T(r()); add(); d += I(r()); space();

	d += A(r()); add(); d += L(r()); add(); d += I(r()); add(); d += A(r()); space();

	d += S(r()); add(); d += STOP(r()); add(); d += STOP(r()); add(); d += STOP(r()); space();
