/*{
    "DESCRIPTION": "SpaceTraveller-XYZW",
...
#define iterations inputColour.x*32
#define formuparam2 inputColour.x*0.90
 
#define volsteps 5
#define stepsize inputColour.z*0.400
 
#define zoom inputColour.y*5.00
#define tile   0.850
#define speed2  0.10
...
#define cloud inputColour.w*0.11 
