...
void _userMain(void)
{
   ...
   sphere[0]= vec4( vec3( sin(time*1.1),  cos(time*0.9),  -3.0+sin(time*0.8))*mouse.y,  0.7*mouse.x);
   sphere[1]= vec4( vec3( cos(time*0.8), -sin(time*1.2),  -3.0+cos(time*0.9))*mouse.y,  0.8*mouse.x);
   sphere[2]= vec4( vec3(-cos(time*1.3),  sin(time*0.7),  -3.0-cos(time*1.0))*mouse.y,  0.9*mouse.x);
