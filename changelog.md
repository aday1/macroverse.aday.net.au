...
- **Macroverse set (Microvirtuosity)** — six compiling ISF shaders in `starter-pack/macroverse/` (Energy Field through Living Our Best Life); gallery preset `macroverse-set` (Shift+0); auto-tagged on index scan.
