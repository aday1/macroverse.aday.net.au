  ...
  moreSheetEl.innerHTML = `
    ...
    <div class="more-sheet-card" role="dialog" aria-modal="true" aria-label="More menu">
      ...
      <div class="more-sheet-grid">
        ...
        <button type="button" class="more-sheet-btn" data-act="pipeline">Pipeline</button>
        <button type="button" class="more-sheet-btn" data-act="wire">Wire Hub</button>
        ...
        <button type="button" class="more-sheet-btn" data-act="paths">Paths</button>
        <button type="button" class="more-sheet-btn" data-act="rescan">Rescan</button>
      </div>
