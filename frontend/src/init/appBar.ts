...
let vrBtn: HTMLButtonElement | null = null;
...
export function initAppBar(): void {
  ...
  vrBtn = el('appBarVr') as HTMLButtonElement | null;
  ...
  // VR role/mode chooser
  vrBtn?.addEventListener('click', openJumpIntoVrChooser);
